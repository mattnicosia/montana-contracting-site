...
function index() {
  ...
  return documentHTML('All Projects', `${projects.length} Montana Contracting projects across New York and New Jersey. Since 1984.`, '/projects/', projects[0].images[0], `${bar(true)}<main id="main"><div class="pall__head"><div class="pall__k"><i aria-hidden="true"></i>Selected Works</div><h1>All Projects</h1><p>${projects.length} projects across New York and New Jersey. Since 1984.</p></div><div class="pall__grid">${cards}</div></main>`);
}
